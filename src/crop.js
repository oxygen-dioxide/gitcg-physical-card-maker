...
export function createCropEditor(containerEl, imageEl, onChange) {
	...
	hint.style.cssText =
		"position:absolute;bottom:4px;left:50%;transform:translateX(-50%);white-space:nowrap;font-size:11px;color:#ccc;text-shadow:0 1px 2px #000;pointer-events:none;";
